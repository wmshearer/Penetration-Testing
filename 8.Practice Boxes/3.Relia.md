...
```bash
# --- 172.16.155.x Subnet ---
172.16.155.6    # VM 1  — no creds
#Flags: 
172.16.155.7    # VM 15 — no creds
#Flags: 
172.16.155.14   # VM 4  — no creds
#Flags: 
172.16.155.15   # VM 6  — no creds
#Flags: 
172.16.155.19   # VM 7  — no creds
#Flags: 
172.16.155.20   # VM 8  — no creds
#Flags: 
172.16.155.21   # VM 9  — no creds
#Flags: 
172.16.155.30   # VM 5  — no creds
#Flags: 

# --- 192.168.195.x Subnet ---
192.168.195.189 # VM 2  — no creds
#Flags: 
192.168.195.191 # VM 3  — no creds
#Flags: 
192.168.195.245 # VM 10 — no creds
#Flags: Anita / 
192.168.195.246 # VM 11 — no creds
#Flags: 
192.168.195.247 # VM 12 — no creds
#Flags: 
192.168.195.248 # VM 13 — no creds
#Flags: 
192.168.195.249 # VM 14 — no creds
#Flags: 
192.168.195.250 # WINPREP ★ offsec / lab
# Nothing here?
